...
func (x *StringResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StringResp) ProtoMessage() {}

func (x *StringResp) ProtoReflect() protoreflect.Message {
	mi := &file_pb_hello_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StringResp.ProtoReflect.Descriptor instead.
func (*StringResp) Descriptor() ([]byte, []int) {
	return file_pb_hello_proto_rawDescGZIP(), []int{1}
}

func (x *StringResp) GetRet() string {
	if x != nil {
		return x.Ret
	}
	return ""
...
func (x *StringResp) GetErr() string {
	if x != nil {
		return x.Err
	}
	return ""
...
var file_pb_hello_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x2b, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x41, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x01, 0x41, 0x12, 0x0c, 0x0a, 0x01, 0x42, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01,
	0x42, 0x22, 0x30, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x12,
	...
	,
...
var file_pb_hello_proto_goTypes = []interface{}{
	...
	(*StringResp)(nil),    // 1: pb.StringResp
}
var file_pb_hello_proto_depIdxs = []int32{
	...
	1, // 2: pb.StringService.Concat:output_type -> pb.StringResp
	1, // 3: pb.StringService.Diff:output_type -> pb.StringResp
